...
void AboutMenu::Draw(SDL_Renderer* rR) {
	CCFG::getText()->DrawWS(rR, "INTERACTIVE MARIO GAME", 150, 128, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "AUTOR: ITISHA and KARAN", 150, 146, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "MARIO V 1.03 - C++ AND SDL2", 150, 188, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "BTP 2ND YEAR", 150, 206, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "game’s features wil change based on the emotions on the player’s face", 150, 224, 0, 0, 0);
